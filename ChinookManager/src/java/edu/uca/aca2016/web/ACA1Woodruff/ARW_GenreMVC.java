 ...
 */
package edu.uca.aca2016.web.ACA1Woodruff;

import edu.uca.aca2016.chinook.ACA1Woodruff.ChinookGenreManager2;
 ...
 * @author awood
 */
public class ARW_GenreMVC extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (mid == null || mid.isEmpty()) {
            ...
            message = "Genre not added, name value was empty or incorrect.";
        }
        ...
        if (id != null && !id.isEmpty()) {
            try {
                ...
                Logger.getLogger(ARW_GenreMVC.class.getName()).log(Level.SEVERE, null, ex);
            }
        }

        RequestDispatcher rd = request.getRequestDispatcher("/ARW_GenreMVC.jsp");
